        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            if (openFileDialog1.ShowDialog() == DialogResult.OK)
            {
                ...
                while (satir != null)
                {
                    ...
                    if (count == 0)
                    {
                        ürünn.UrunKodu = Convert.ToInt32(itemler[0].Trim());
                        ürünn.Barkod = "869" + ürünn.UrunKodu.ToString();
                        count = count + 1;
                    }

                    if (count == 1)
                    {
                        ürünn.Cesit = itemler[1].Trim();
                        count = count + 1;
                    }

                    if (count == 2)
                    {
                        ürünn.StokMiktari = Convert.ToInt32(itemler[2].Trim());
                        count = count + 1;
                    }

                    if (count == 3)
                    {
                        ürünn.UrunAdi = itemler[3].Trim();
                        count = count + 1;
                    }
                    ...
                    if (count == 4)
                    {
                        ...
                        //ürünn.BirimGirdiFiyat = Convert.ToDouble(itemler[4].Trim());
